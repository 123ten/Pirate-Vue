    ...
    <div class="edit-main mb_16">
      ...
      >
        ...
        <a-form-item label="用户昵称" v-bind="validateInfos.nickname">
          <a-input v-model:value="formInfo.nickname" placeholder="请输入用户昵称" />
        </a-form-item>
        <a-form-item label="邮箱地址">
          <a-input v-model:value="formInfo.email" placeholder="请输入邮箱地址" />
        </a-form-item>
        <a-form-item label="手机号码">
          <a-input v-model:value="formInfo.email" placeholder="请输入手机号码" />
        </a-form-item>
